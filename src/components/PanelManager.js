...
export function initPanelManager(container) {
  container.innerHTML = `
    <div class="panel-tabs">
      <button class="panel-tab active" data-panel="properties" data-tooltip="Tool Properties & Controls">Properties</button>
      <button class="panel-tab" data-panel="histogram" data-tooltip="RGB & Grayscale Histogram">Histogram</button>
      <button class="panel-tab" data-panel="layers" data-tooltip="Edit History & Layers">Layers</button>
      <button class="panel-collapse-btn" id="btn-collapse-panels" data-tooltip="Minimize Panel (Ctrl+B)">
  ...
  subscribe('panelsCollapsed', (collapsed) => {
    if (collapseBtn) {
      collapseBtn.setAttribute('data-tooltip', collapsed ? 'Expand Panel (Ctrl+B)' : 'Minimize Panel (Ctrl+B)');
